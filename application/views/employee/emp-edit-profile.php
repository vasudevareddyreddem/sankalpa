        ...
        <div class="panel panel-primary setup-content" id="step-1">
            ...
            <div class="panel-body">
				...
				<div class="form-group col-md-6">
					...
					<select class="form-control" readonly required id="type_of_emp" name="type_of_emp" onchange="get_type_of_emp(this.value);">
						<option value="">Select</option>
				...
				<div class="form-group col-md-6">
					...
					<select class="form-control" readonly required id="months" name="months" >
						<option value="">Select</option>
				...
				<div class="form-group col-md-6">
					...
					<select class="form-control" readonly required id="notice_period" name="notice_period" onchange="get_notice_period(this.value);">
						<option value="">Select</option>
				...
				<div class="form-group col-md-6">
                    <label class="control-label">Months</label>
					<select class="form-control" readonly required id="n_p_months" name="n_p_months" >
						<option value="">Select</option>
        ...
        <div class="panel panel-primary setup-content" id="step-3">
            ...
            <div class="panel-body">
                 <div class="form-group col-md-6">
				    	...
				    	<input type="text" class="form-control"  readonly name="basicsalary" id="basicsalary" required="true"  placeholder="Enter Basic Salary" value="<?php echo isset($emp_d['basicsalary'])?$emp_d['basicsalary']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone">HRA</label>
				    	<input type="text" class="form-control"  readonly name="hra" id="hra"  placeholder="Enter HRA" required="true" value="<?php echo isset($emp_d['hra'])?$emp_d['hra']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone">Special Allowance</label>
				    	<input type="text" class="form-control"  readonly name="specialallowance" id="specialallowance" required="true"  placeholder=" Enter Special Allowance" value="<?php echo isset($emp_d['specialallowance'])?$emp_d['specialallowance']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone">Conveyance</label>
				    	<input type="text" class="form-control" readonly  name="conveyance" id="conveyance" required="true"  placeholder="Enter Conveyance" value="<?php echo isset($emp_d['conveyance'])?$emp_d['conveyance']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone">Medical Reimbursement</label>
				    	<input type="text" class="form-control" readonly  name="medicalreimbursement" id="medicalreimbursement" required="true"  placeholder="Enter  Medical Reimbursement" value="<?php echo isset($emp_d['medicalreimbursement'])?$emp_d['medicalreimbursement']:''; ?>">
		  			</div>
		  			<div class="form-group col-md-6">
				    	<label for="telephone">PF Number</label>
				    	<input type="text" class="form-control" readonly name="pfnumber" id="pfnumber" required="true"  placeholder="Enter PF Number" value="<?php echo isset($emp_d['pfnumber'])?$emp_d['pfnumber']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone">PF - Employee Contribution</label>
				    	<input type="text" class="form-control" readonly name="employee_pfamount" id="employee_pfamount" required="true" placeholder="Enter Employee PF Amount" value="<?php echo isset($emp_d['employee_pfamount'])?$emp_d['employee_pfamount']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone"> PF - Employer Contribution</label>
				    	<input type="text" class="form-control" readonly name="employer_pfamount" id="employer_pfamount" required="true" placeholder="Enter Employer PF Amount" value="<?php echo isset($emp_d['employer_pfamount'])?$emp_d['employer_pfamount']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone">Professional Tax</label>
				    	<input type="text" class="form-control" readonly name="pt" id="pt" required="true" placeholder="Enter PT Amount" value="<?php echo isset($emp_d['pt'])?$emp_d['pt']:''; ?>">
		  			</div>
		  			<div class="form-group col-md-6">
				    	<label for="telephone">ESI Number</label>
				    	<input type="text" class="form-control" readonly name="employee_esi" id="employee_esi" required="true" placeholder="Enter ESI Number" value="<?php echo isset($emp_d['employee_esi'])?$emp_d['employee_esi']:''; ?>">
		  			</div>
					
					<div class="form-group col-md-6">
				    	<label for="telephone">ESI - Employee Contribution</label>
				    	<input type="text" class="form-control" readonly name="employee_contribution_esi" id="employee_contribution_esi" required="true" placeholder="Enter Employee ESI Amount" value="<?php echo isset($emp_d['employee_contribution_esi'])?$emp_d['employee_contribution_esi']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone"> ESI - Employer Contribution</label>
				    	<input type="text" class="form-control" readonly name="employer_contribution_esi" id="employer_contribution_esi" required="true" placeholder="Enter Employer ESI Amount" value="<?php echo isset($emp_d['employer_contribution_esi'])?$emp_d['employer_contribution_esi']:''; ?>">
		  			</div>
		  			<div class="form-group col-md-6">
				    	<label for="telephone">Others</label>
				    	<input type="text" class="form-control" readonly name="others" id="others" required="true" placeholder="Enter Any Other Amount" value="<?php echo isset($emp_d['others'])?$emp_d['others']:''; ?>">
		  			</div>		  			
					<div class="form-group col-md-6">
				    	<label for="telephone">Bank Name</label>
				    	<input type="text" class="form-control" readonly name="bankname" id="bankname" required="true"   placeholder="Enter Bank Name" value="<?php echo isset($emp_d['bankname'])?$emp_d['bankname']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone">IFSC Code</label>
				    	<input type="text" class="form-control" readonly name="ifsc" id="ifsc" required="true"   placeholder="Enter IFSC Code" value="<?php echo isset($emp_d['ifsc'])?$emp_d['ifsc']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone">Bank Account No</label>
				    	<input type="text" class="form-control" readonly name="bankaccountnumber" required="true"  id="bankaccountnumber"  placeholder="Enter Bank Account No" value="<?php echo isset($emp_d['bankaccountnumber'])?$emp_d['bankaccountnumber']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone">Advance (If Any)</label>
				    	<input type="text" class="form-control" readonly name="advance" id="advance" required="true" placeholder="Enter Advance Amount" value="<?php echo isset($emp_d['advance'])?$emp_d['advance']:''; ?>">
		  			</div>
					
					<div class="form-group col-md-6">
				    	<label for="telephone"> Employee Buyout (If Any)</label>
				    	<input type="text" class="form-control" readonly name="employee_buyout" id="employee_buyout" placeholder="Enter Employee Buyout (If Any)" value="<?php echo isset($emp_d['employee_buyout'])?$emp_d['employee_buyout']:''; ?>">
		  			</div>
					
					<div class="form-group col-md-6">
				    	<label for="telephone"> Relocation Allowance (If Any)</label>
				    	<input type="text" class="form-control" readonly name="relocation_allowance" id="relocation_allowance" placeholder="Enter Relocation Allowance (If Any)" value="<?php echo isset($emp_d['relocation_allowance'])?$emp_d['relocation_allowance']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone">Net Salary</label>
				    	<input type="text" class="form-control" readonly name="netsalary" id="netsalary" placeholder="Enter Net Salary" value="<?php echo isset($emp_d['netsalary'])?$emp_d['netsalary']:''; ?>">
		  			</div>
					<div class="form-group col-md-6">
				    	<label for="telephone">Gross Salary</label>
				    	<input type="text" class="form-control" readonly name="gross_salary" id="gross_salary" placeholder="Enter Gross Salary" value="<?php echo isset($emp_d['gross_salary'])?$emp_d['gross_salary']:''; ?>">
		  			</div>
