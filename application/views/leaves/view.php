<head>
<link href="http://localhost/h_hrms/assets/vendor/css/gsdk-bootstrap-wizard.css" rel="stylesheet">
</head>
<style>
.nav-pills > li  {
    margin-left: 0;
...
<div class="content-wrapper">
  ...
  <?php foreach($d_list as $li){ ?>
    <div class="panel panel-default">
      ...
      <div id="collapseOne<?php echo $li['d_id']; ?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne<?php echo $li['d_id']; ?>">
