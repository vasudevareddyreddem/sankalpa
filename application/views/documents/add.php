<div class="content-wrapper">
   <section class="content-header mb-4">
      ...
      <ol class="breadcrumb">
         ...
         <li><a href="<?php echo base_url('document'); ?>"><i class="fa fa-list"></i> list</a></li>
         ...
         <div class="col-md-12 bg-white">
            ...
            <div class=" ">
			   ...
			   <fieldset class="scheduler-border">
                  ...
                  <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo base_url('document/addpost'); ?>" enctype="multipart/form-data">
                     	<?php $csrf = array(
